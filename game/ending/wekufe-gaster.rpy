label wekufeEndingGaster:
  ...
  show sansImg hoddie surprised flip at fade with dissolve:
    xpos 0.5
  sans "who?"
  frisk "Papyrus!"
  ...
  show coo at fade with dissolve:
    xpos -0.1
  coo "I have a letter for you"
  show friskImg angry mild flip at fade with dissolve:
    xpos 0.5
    ypos 0.13
  ...
  show sansImg hoddie worried flip at fade with dissolve:
    xpos 0.2
  sans "wait!"
  frisk "They's gone"
  show sansImg hoddie angry
  pause(1)
  show sansImg hoddie annoyed
  text "MY DEAR SANS:"
  ...
  frisk "Sans?"
  play sound "music/fx/steps.wav"
  show torielImg teacher neutral zorder 2 at fade with dissolve:
    xpos 0.0
  toriel "Here you are"
  ...
  sans "oh..."
  sans "sure..."
  show friskImg worried flip at fade with dissolve:
    xpos 0.2
    ypos 0.13
