...
label papyrusGasterConversation:
    ...
    scene tryWithSans lookingTheDistance frame1 with dissolve:
        ypos 0.0
        linear 20 ypos -0.9
    ...
    scene tryWithSans lookingTheDistance frame2 with dissolve:
        ypos -0.9
        linear 20 ypos 0.0
    ...
    gaster "BUT I CANNOT STOP FEARING SOMEDAY IS GOING TO AGAIN BACKFIRE LIKE..."
    gaster "THAT TIME AT THE EXIT OF SNOWDIN"
    papyrus "..."
    papyrus "I..."
    papyrus "I DON'T KNOW"
    papyrus "I WOULD LIKE TO SOMEONE ELSE TO TRUST ME AS YOU DO"
    papyrus "BUT I ALWAYS FEEL... SO SEPARATED AT TIMES..."
    gaster "AHH..."
    gaster "I KNOW THE FEELING..."
    scene tryWithSans lookingTheDistance frame3 with dissolve:
        xpos 0.0
        linear 20 xpos -0.2
    ...
    show gaster trapped happy flip at fade:
        xpos 0.3
