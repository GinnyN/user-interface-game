...
define undynePhone = Character("Phone", color="#00FF00", what_prefix="* ", callback=undyne_voice)
...
define dogaim = Character("Dogaim", color="#8888FF", what_prefix="* ", callback=default_voice)
