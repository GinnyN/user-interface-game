label visitMettaton:
    ...
    pause(1)
    show papyrusImg coolDude happy at fade:
        xpos 0.3
        ypos 0.1
    show gaster trapped angry at fade:
        xpos -0.1
    papyrus "YES, YES IT IS"
    papyrus "I TOTALLY FORGOT ABOUT THAT"
    gaster "YOU HAVE TO STOP THIS PAPYRUS, THAT MONSTER IS JUST A CULT LEADER WHICH IS USING HUMAN TECHNIQUES TO CONTROL THE MONSTERS INTO DOING HIS"
    show gaster trapped dissapointed
    gaster "YOU AREN'T LISTENING, ARE YOU?"
    show papyrusImg coolDude realizing
