...
image undyneImg armor serious = im.FactorScale("undyne/armor/serious.png", 0.75)
image undyneImg armor serious flip = im.Flip(im.FactorScale("undyne/armor/serious.png", 0.75), horizontal=True)
image undyneImg armor surprised = im.FactorScale("undyne/armor/surprised.png", 0.75)
image undyneImg armor surprised flip = im.Flip(im.FactorScale("undyne/armor/surprised.png", 0.75), horizontal=True)
image undyneImg armor sorry = im.FactorScale("undyne/armor/sorry.png", 0.75)
image undyneImg armor sorry flip = im.Flip(im.FactorScale("undyne/armor/sorry.png", 0.75), horizontal=True)
image undyneImg armor worried = im.FactorScale("undyne/armor/worried.png", 0.75)
image undyneImg armor worried flip = im.Flip(im.FactorScale("undyne/armor/worried.png", 0.75), horizontal=True)
