label afternoonSans:
  if tryWithSans:
        call freeSansAlt from _call_freeSansAlt
  else:
    ...
    show papyrusImg coolDude sorry
    ...
    show papyrusImg coolDude offended flip zorder 0 at fade:
      xpos 0.4
    ...
    grillsby "..."
    show sansImg hoddie tired flip
    ...
    show papyrusImg coolDude neutral zorder 0 at fade:
      xpos 0.4
      ypos 0.0
    papyrus "I'M OUT!"
