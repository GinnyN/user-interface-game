label afternoonToriel:
  ...
  toriel "..."
  hide torielImg
  show papyrusImg coolDude uhh zorder 1 at fade:
    xpos -0.1
  ...
  toriel "Really?"
  scene freeAfternoon toriel1 with dissolve
  ...
  show torielImg teacher angry zorder 2 at fade:
    xpos 0.0
  toriel "I told everything I knew about everything to Gerson all those years ago"
  toriel "Why should you think I know something is not written there?"
  show papyrusImg coolDude careful flip zorder 1 at fade:
    xpos 0.3
  papyrus "WEELL....."
  toriel "Papyrus..."
  papyrus "..."
  show torielImg teacher explaining
  ...
  scene toriel house with dissolve
  pause(0.5)
  show torielImg teacher neutral flip zorder 0 at fade:
    xpos 0.3
  toriel "I'm back"
