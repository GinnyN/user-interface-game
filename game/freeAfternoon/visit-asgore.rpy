label afternoonAsgore:
    ...
    gaster "NAH, THE KING IS UNABLE TO ACTUALLY MAKE DESICIONS"
    ...
    scene school outside with dissolve:
        ypos -0.3
    show papyrusImg coolDude uhh zorder 0 at fade:
        xpos -0.1
    ...
    scene school outside with vpunch:
        ypos -0.3
    show asgoreImg shirt explaining flip zorder 3 at fade:
        xpos 0.3
        ypos -0.15
    asgore "There's something you need Papyrus?"
    show papyrusImg coolDude surprised happy zorder 0 at fade:
        xpos -0.1
    ...
    show asgoreImg shirt crossed flip
    ...
    show asgoreImg shirt doubt flip
    asgore "Wait."
    show papyrusImg coolDude uhh
    papyrus "YEAH"
    ...
    hide asgoreImg
    play sound "music/fx/steps.wav"
    show papyrusImg coolDude desperate zorder 0 at fade:
        xpos -0.1
    ...
    show papyrusImg coolDude desperate zorder 1 at fade:
        xpos -0.2
    papyrus "I KNOW ALREADY HE'S NOT SO PLEASE DON'T DO THIS TO ME"
    show asgoreImg shirt embarrased flip
    asgore "Do you know already?"
    show sansImg hoddie neutral flip zorder 2 at fade:
            xpos 0.6
    sans "oh, papyrus, your majesty"
    show asgoreImg shirt serious
    asgore "hello sans"
