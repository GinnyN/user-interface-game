...
init -1 python hide:
    ...
    config.window_title = u"User Interface"
    ...
    style.window.background = Frame("box.png", 12, 12)
    ...
    style.default.font = "fonts/DTM-Sans.otf"
...
python early:
    config.save_directory = "UserInterface-1451352351"
